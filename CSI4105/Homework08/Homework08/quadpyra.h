...
public:
    ...
    void initBuffers() {
        ...
        for(int i = 0; i < 4; i++)
        {
            _quadPyraSmoothNormals[3*i] = quadPyraFlatNormals[36];
            _quadPyraSmoothNormals[3*i+1] = quadPyraFlatNormals[37];
            _quadPyraSmoothNormals[3*i+2] = quadPyraFlatNormals[38];
        }
